...
<table class="table table-condensed">
    ...
    <tbody>
		...
		echo '<tr>';
		echo '<td>';
		echo '<a class="playplaylist btn btn-xs btn-primary" data-syno_id="' . init('id') . '" data-name="Liste de lecture aléatoire"><i class="fa fa-play"></i></a>';
		echo '</td>';
		...
		echo '<tr>';
		echo '<td>';
		echo '<a class="playplaylist btn btn-xs btn-primary" data-syno_id="' . init('id') . '" data-name="Liste des musiques récentes"><i class="fa fa-play"></i></a>';
		echo '</td>';
		echo '<td style="font-weight: bold;">';
		...
		foreach (synoaudio::getPlayLists() as $playlist) {
			if ($playlist->name != '__SYNO_AUDIO_SHARED_SONGS__'){
				echo '<tr>';
				echo '<td>';
				echo '<a class="playplaylist btn btn-xs btn-primary" data-syno_id="' . init('id') . '" data-name="' . $playlist->name . '"><i class="fa fa-play"></i></a>';
				echo '</td>';
				echo '<td>';
				echo $playlist->name;
				echo '</td>';
