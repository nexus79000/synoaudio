...
<a class="btn btn-danger pull-right" id="bt_emptyQueue" data-syno_id="<?php echo init('id');?>"><i class="fas fa-trash-o"></i> {{Vider}}</a>
<br/><br/>
...
foreach ($syno->getQueue($syno->getLogicalId()) as $song) {
	echo '<tr>';
	echo '<td>';
	echo '<a class="removeTrack btn btn-xs btn-danger" data-position="' . $i . '" data-syno_id="' . init('id') . '"><i class="fas fa-times"></i></a> ';
	echo '<a class="playTrack btn btn-xs btn-primary" data-position="' . $i . '" data-syno_id="' . init('id') . '"><i class="fas fa-play"></i></a>';
	echo '</td>';
	echo '<td>';
	echo $song->title;
	echo '</td>';
